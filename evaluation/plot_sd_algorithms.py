...
def main():
    ...
    ax = sns.factorplot(x="ALGORITHM", y="STANDARD DEVIATION", hue="SETTING", data=plotting_data_df,
    ...
    ax.fig.suptitle('Standard Deviation in the ' + CORPUS_NAME_DICT[args.corpus] + ' Corpus')

    # Save the plot.
    plot_path = args.plot_path + '/sd_algorithms.' + args.corpus + '.whole.1.0.top_10.pdf'
